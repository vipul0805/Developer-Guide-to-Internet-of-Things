...
try:
    gatewayOptions = {"org": "vk74ch", "type": "raspberrypiGW", "id": "b827ebf3431f", "auth-method": "token", "auth-token": "rambodog"}
	...
	sense.set_pixels(getPixelMap(currBgColor, sense.get_temperature()))
        gatewayCli.publishDeviceEvent("sensehat", "senb827ebf3431f", "Event", "json", myData, qos=1 )
        time.sleep(2)
